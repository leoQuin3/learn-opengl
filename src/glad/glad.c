/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Wed Mar 26 01:02:32 2025.
    ...
    Commandline:
        --profile="core" --api="gl=4.6,gles1=1.0" --generator="c" --spec="gl" --local-files --extensions=""
    Online:
